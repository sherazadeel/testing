    ...
    <div className='flex items-center justify-center gap-[20px]'>
      <div className='bg-[#d1d8e0] rounded-xl w-[500px] h-[300px] mt-[50px] flex flex-col gap-[100px]'>
        ...
        <div className='flex item-center justify-around'>
            <Link to='/Admin/login' className='w-[100px] flex items-center justify-center bg-[red] text-[20px] p-[5px] rounded-2xl text-white'>Log-in</Link>
            <Link to="/Admin/sign-up" className='underline mt-[20px]'>Create Account</Link>
        </div>
      </div>
    </div>
  )
